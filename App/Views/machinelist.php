    ...
    <div class="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-gradient-to-br from-[#214969] to-[#1a3850] rounded-xl overflow-hidden shadow-xl">
                ...
                <!-- Contenido de la tarjeta -->
                <div class="p-6">
                    <h2 class="text-[#5DA6C3] font-bold text-xl mb-3 flex items-center space-x-2">
                        <i class="fas fa-desktop text-lg"></i>
                        <span>Máquina 2</span>
                    </h2>
                    <!-- Detalles de la máquina -->
    ...
    <div class="flex justify-center items-center mt-4">
        <nav aria-label="Page navigation example">
            <ul class="inline-flex">
                <li>
                    <a href="#" class="flex items-center justify-center px-4 h-10 ms-0 leading-tight text-gray-700 bg-white border border-e-0 border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-gray-900 dark:bg-[#0e1826] dark:border-gray-700 dark:text-gray-200 dark:hover:bg-[#162737] dark:hover:text-white">Previous</a>
                </li>
                <li>
                    <a href="#" class="flex items-center justify-center px-4 h-10 leading-tight text-gray-700 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-900 dark:bg-[#0e1826] dark:border-gray-700 dark:text-gray-200 dark:hover:bg-[#162737] dark:hover:text-white">1</a>
                </li>
                <li>
                    <a href="#" class="flex items-center justify-center px-4 h-10 leading-tight text-gray-700 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-900 dark:bg-[#0e1826] dark:border-gray-700 dark:text-gray-200 dark:hover:bg-[#162737] dark:hover:text-white">2</a>
                </li>
                <li>
                ...
                <li>
                    <a href="#" class="flex items-center justify-center px-4 h-10 leading-tight text-gray-700 bg-white border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-gray-900 dark:bg-[#0e1826] dark:border-gray-700 dark:text-gray-200 dark:hover:bg-[#162737] dark:hover:text-white">Next</a>
                </li>
            </ul>
        </nav>
    </div>
